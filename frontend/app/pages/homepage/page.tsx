...
export default function Home() {
  ...
  return (
    <div className="flex p-4 flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 text-gray-800">
      ...
      {!isLoggedIn ? (
        <button
          className="flex items-center mt-5 px-6 py-3 bg-[#ffb703] hover:bg-[#f8c915] text-black rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition"
          onClick={() => {
            setIsModalOpen(true);
            setIsSignUp(false);
            resetFields();
